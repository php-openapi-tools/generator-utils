...
all-raw: ## The real runs everything, but due to sponge it has to be ran inside DOCKER_RUN ##U##
	$(MAKE) generate-readme composer-validate syntax-php composer-normalize rector-upgrade cs-fix cs stan unit-testing mutation-testing composer-require-checker composer-unused backward-compatibility-check ## Count: 13
...
## Our default jobs
generate-readme: ## Generate README.md with docbot ##*A*##
	$(DOCKER_RUN) sh -c 'cd etc/qa && ../../vendor/bin/docbot execute'
...
task-list-ci-all: ## CI: Generate a JSON array of jobs to run on all variations
	@echo "[\"generate-readme\",\"composer-validate\",\"syntax-php\",\"cs\",\"stan\",\"unit-testing\",\"mutation-testing\",\"composer-require-checker\",\"composer-unused\",\"backward-compatibility-check\"]" ## Count: 10
